...
ResultSet rsm = (ResultSet) session.getAttribute("rsm");
ResultSet rsps = (ResultSet) session.getAttribute("rsps");
String matv = " ";
...
List<Prof> etudList = (List<Prof>) session.getAttribute("lprf");
