...
<title>Organisation Des groupes</title>
<!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-200">
	...
	<section class="home-section">
		<div class="home-content">
			...
			<div>
				<a href="Ajoutergrpsorgt.jsp"><button>
						<i class="bi bi-plus-square-fill"></i> Ajouter Un Groupe
					</button></a>
			</div>
		</div>
		...
		<main
			...
			<div style="font-family: 'Red Hat Display', sans-serif;display: flex;align-items: center;margin-left: 73%;font-size:14pt;margin-bottom:13px;"><span>Home/Organisation</span><span style="color: #2596be;">/</span><span style="color: #2596be; text-decoration: underline;">Groupes</span></div>
