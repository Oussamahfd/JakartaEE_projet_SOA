...
<body class="g-sidenav-show  bg-gray-200">
	...
	<div class="fr" style=" width: 80%; float: right;margin-right: 7%;background-color:white; border-radius:10px;">
      ...
      <label for="student-formation" style="color:black;">Description de l'annonce</label>
      <textarea style="width:50%;margin-left:12px;border-color:black;border-radius:7px;" class="form-control" id="formation" placeholder="Entrez la description de l'annonce" name="formation"></textarea>
   </div>
