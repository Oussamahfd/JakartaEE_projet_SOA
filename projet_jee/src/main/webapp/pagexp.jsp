...
<body class="g-sidenav-show  bg-gray-200">
	...
	<section class="home-section">
		<div class="home-content">
			...
			<div>
				<a href="Ajouteretudsgest.jsp"><button>
						<i class="bi bi-plus-square-fill"></i> Ajouter Etudiant(e)
					</button></a>
			</div>
		</div>
		...
		<main
			...
			<div style="font-family: 'Red Hat Display', sans-serif;display: flex;align-items: center;margin-left: 73%;font-size:14pt;margin-bottom:13px;"><span>Home/Gestion</span><span style="color: #2596be;">/</span><span style="color: #2596be; text-decoration: underline;">Etudiants</span></div>
			 <div class="search-container" style="margin-left: 59%;">
  <form action="pagexp.jsp" method="get">
    <select class="education-level" name="education">
        <option class="opt" value="primary">1-BAC SCIENCES X</option>
        <option class="opt" value="secondary">1-BAC LETTERE</option>
        <option class="opt" value="2-bac-sm">2-BAC SC.MATH</option>
        <option class="opt" value="2-bac-pc">2-BAC SC.PC</option>
    ...
    <select class="education-level" name="group">
						...
						<div class="card my-4" style="border-radius:12px;">
							<div
								...
								<div class=" shadow p-3 border-radius-lg pt-4 pb-3" style="BACKGROUND-COLOR:BLACK;">
									<h6 class="text-white text-capitalize ps-3" style="text-align:center;font-size:18pt;"><b>Table Des Etudiants</b></h6>
								</div>
							</div>
	...
	<% ResultSet rs = et.alletud();  String es=" ";
	int cmp =0;
	List<Etud> etudList = new ArrayList<>();
	while (rs.next()) {
        ...
        Etud etud = new Etud(id, nom, prenom, email, tel, role, nv);
        etudList.add(etud);
        cmp++;
    }
...
%>
											...
											<tr>
											<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%= etud.getId() %></p>
												...
												<td>
													<div class="d-flex px-2 py-1">
														...
														<div class="d-flex flex-column justify-content-center">
															<h6 class="text-center mb-0 text-sm"><%= etud.getNom() %><%=es %><%= etud.getPrenom() %></h6>
															<p class="text-center text-xs text-secondary mb-0"><%= etud.getEmail() %></p>
														</div>
													</div>
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%= etud.getRole() %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%= etud.getTel() %></p>
													
												</td>
												
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%= etud.getNv() %></p>
													
												</td>
																			
											
																	<td class="align-middle" style="color: green;">
    <form action="Editetd.jsp" method="post">
        <input type="hidden" name="userIddd" value="<%= etud.getId() %>">
        <button type="submit" class="text-secondary font-weight-bold green text-xs" style="color: green;" data-toggle="tooltip" data-original-title="Edit user">
            Edit
												...
												<td class="align-middle">
														 ...
														 <form action="Suppet" method="post">
        <input type="hidden" name="userIddd" value="<%= etud.getId() %>">
        <button type="submit" class="text-secondary font-weight-bold green text-xs" style="color: green;" data-toggle="tooltip" data-original-title="Edit user">
            supprimer
        </button>
