		...
		<main
			...
			<div
				...
				<span>Home/Emploi</span><span style="color: #2596be;">/</span><span
					style="color: #2596be; text-decoration: underline;">Groupes</span>
			</div>
			<div class="search-container" style="margin-left: 59%;">
			<form style="display: flex; align-items: center;" action="Serchgrpsemplois"  method="post">
