	...
	<section class="home-section">
		...
		<main
			...
			<div class="fr"
				...
				<h1 style="font-family: 'FS Me', sans-serif; margin-left: 113px;">Ajouter
					Un prof</h1>
				<form method="POST" action="Ajtprf">
					<div class="form-group"
						...
						<label for="student-name" style="color: black;">Nom </label> <input
							...
							placeholder="Entrez le nom de l'étudiant" name="Nom"> <label
							for="student-id" style="color: black;">Prenom </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="id_etudient"
							placeholder="Entrez l'ID de l'étudiant" name="Prenom">
					</div>
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Mail </label> <input
							...
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							placeholder="Entrez le nom de l'étudiant" name="Mail"> <label
							for="student-id" style="color: black;">Phone </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="id_etudient"
							placeholder="Entrez l'ID de l'étudiant" name="Phone">
					</div>
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Password </label>
						<input type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							placeholder="Entrez le nom de l'étudiant" name="Password">
						<label for="student-name" style="color: black;">Salaire </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							placeholder="Entrez le nom de l'étudiant" name="Salaire">
					...
					<div class="form-group"
						...
						<label for="student-name" style="color: black;">Matiere </label> <input
							...
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							placeholder="Entrez le nom de l'étudiant" name="Matiere">
						<datalist id="mat">
                  ...
                  <input list="niveaux" type="text"
									style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
									class="form-control" id="nom_etudient"
									placeholder="Entrez le nom de l'étudiant" name="Niveau">
                  <datalist id="niveaux">
