<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%
    String idconn = (String) session.getAttribute("fullnm");
    if (idconn == null) {
...
<body class="g-sidenav-show  bg-gray-200">
	...
	<div class="search-container" style="margin-left: 59%;">
				<form style="display: flex; align-items: center;" action="Serchetud"  method="post">
				<select class="education-level" name="nive">
					<option class="opt" value="2-bac-pc">2-bac-pc</option>
					<option class="opt" value="2-bac-sm-a">2-bac-sm-a</option>
					<option class="opt" value="2-bac-sm-b">2-bac-sm-b</option>
