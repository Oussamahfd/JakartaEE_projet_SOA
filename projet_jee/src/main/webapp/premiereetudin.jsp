...
<body class="g-sidenav-show  bg-gray-200">
	...
	<div class="sidebar close" style="background-color:black;">
		...
		<ul class="nav-links">
			...
			<li>
				<div class="iocn-link" >
					<a href="intetuempl.jsp"> <i class='bx bxs-calendar'></i> 
					<span
	...
	<section class="home-section">
		...
		<main
			...
			<div style="font-family: 'Red Hat Display', sans-serif;display: flex;align-items: center;margin-left: 73%;font-size:14pt;margin-bottom:13px;"><span>Home</span><span style="color: #2596be;">/</span><span style="color: #2596be; text-decoration: underline;">Paiement</span></div>
						...
						<div class="card my-4" style="border-radius:12px;">
							<div
								...
								<div class=" shadow p-3 border-radius-lg pt-4 pb-3" style="BACKGROUND-COLOR:BLACK;">
									<h6 class="text-white text-capitalize ps-3" style="text-align:center;font-size:18pt;"><b>Table des paiments</b></h6>
								</div>
							</div>
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0">
									<table class="table align-items-center mb-0">
										...
										<% ResultSet rs = et.oneetpai(fullId);  String es=" ";%>
										<tbody>
										<%while(rs.next()){ %>
												...
												<td>
													<div class="d-flex px-2 py-1">
														...
														<div class="d-flex flex-column justify-content-center">
															...
															<p class="text-center text-xs text-secondary mb-0"><%=rs.getString("mail") %></p>
														</div>
													</div>
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("octorbe")) { %>
            ...
            <% } %></p>
												...
												<td>
																<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("novembre")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
																<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("decembre")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
																<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("janvier")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
																<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("fevrier")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
																<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("mars")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
																<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("avril")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
			<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("mai")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
												...
												<td>
			<p class="text-center text-xs font-weight-bold mb-0"><% if (rs.getBoolean("juin")) { %>
                <i class="fa-solid fa-circle-check" style="color:green;"></i>
            <% } else { %>
                <i class="fa-solid fa-circle-xmark" style="color:red;"></i>
            <% } %></p>
