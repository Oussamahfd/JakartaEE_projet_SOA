...
<title>Absence Table<%=fullId %></title>
<!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-200">
	...
	<section class="home-section">
		...
		<main
			...
			<div style="font-family: 'Red Hat Display', sans-serif;display: flex;align-items: center;margin-left: 73%;font-size:14pt;margin-bottom:13px;"><span>Home</span><span style="color: #2596be;">/</span><span style="color: #2596be; text-decoration: underline;">Absence</span></div>
						...
						<div class="card my-4" style="border-radius:12px;">
							<div
								...
								<div class=" shadow p-3 border-radius-lg pt-4 pb-3" style="BACKGROUND-COLOR:BLACK;">
									<h6 class="text-white text-capitalize ps-3" style="text-align:center;font-size:18pt;"><b>Table D'absence</b></h6>
								</div>
							</div>
	...
	<% ResultSet rs = et.oneetabs(fullId);  String es=" ";%>
										<tbody>
										<%while(rs.next()){ %>
											...
											<tr>
											<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("user_id") %></p>
												...
												<td>
													<div class="d-flex px-2 py-1">
														...
														<div class="d-flex flex-column justify-content-center">
															<h6 class="text-center mb-0 text-sm"><%=rs.getString("nom") %><%=es %><%=rs.getString("prenom") %></h6>
															<p class="text-center text-xs text-secondary mb-0"></p>
														</div>
													</div>
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("octorbe") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("novembre") %></p>
													
												</td>
												
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("decembre") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("janvier") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("fevrier") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("mars") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("avril") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("mai") %></p>
													
												</td>
												<td>
													<p class="text-center text-xs font-weight-bold mb-0"><%=rs.getInt("juin") %></p>
