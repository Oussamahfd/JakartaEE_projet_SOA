...
<title>Ajouter Paiement Etudiant(e)</title>
<!--     Fonts and icons     -->
		...
		<main
			...
			<div class="fr"
				...
				<h1 style="font-family: 'FS Me', sans-serif; margin-left: 113px;">Ajouter une paiment</h1>
					...
					<% ResultSet rs = et.collecteetud(idf);  String es=" ";
					Integer user_id = (Integer) session.getAttribute("ideditp");
			        int userId = user_id.intValue();
					ResultSet rss= et.collectmoinp(userId);
					%>
					<%while(rs.next()){ %>
				<form method="POST" action="Ajtpaim">
					...
					<div class="form-group"
						...
						<label for="student-name" style="color: black;">Niveau </label> <input
							...
							<label
							for="student-id" style="color: black;">Mois Non payé </label> <input list="mois" type="text"
									style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
									class="form-control" id="nom_etudient"
									value="" name="moi">
                  <datalist id="mois">
