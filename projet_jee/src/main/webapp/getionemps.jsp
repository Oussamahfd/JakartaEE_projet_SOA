...
<body class="g-sidenav-show  bg-gray-200">
	...
	<section class="home-section">
		<div class="home-content">
			...
			<div>
				<a href="Ajouterempsgest.jsp"><button>
						<i class="bi bi-plus-square-fill"></i> Ajouter Employé(e)
					</button></a>
			</div>
		</div>
		...
		<main
			...
			<div style="font-family: 'Red Hat Display', sans-serif;display: flex;align-items: center;margin-left: 73%;font-size:14pt;margin-bottom:13px;"><span>Home/Gestion</span><span style="color: #2596be;">/</span><span style="color: #2596be; text-decoration: underline;">Employés</span></div>
						...
						<div class="card my-4" style="border-radius:12px;">
							<div
								...
								<div class=" shadow p-3 border-radius-lg pt-4 pb-3" style="BACKGROUND-COLOR:BLACK;">
									<h6 class="text-white text-capitalize ps-3" style="text-align:center;font-size:18pt;"><b>Table Des Employes</b></h6>
								</div>
							</div>
								...
								<div class="table-responsive p-0">
									<table class="table align-items-center mb-0">
										<thead>
											<tr>
												<th
													class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Employes</th>
