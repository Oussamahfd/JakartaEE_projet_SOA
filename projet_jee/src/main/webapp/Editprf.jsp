...
<title>Modification Profs</title>
<!--     Fonts and icons     -->
	...
	<section class="home-section">
		...
		<main
			...
			<div class="fr"
				...
				<h1 style="font-family: 'FS Me', sans-serif; margin-left: 113px;">Modification des informations</h1>
				...
				<form method="POST" action="Edit">
					...
					<div class="form-group"
						...
						<label for="student-name" style="color: black;">Salaire </label> <input
							...
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getFloat("salaire")%>" name="Salaire">
					...
					<div class="form-group"
						...
						<label for="student-name" style="color: black;">Matiere </label> <input
							...
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("mail")%>" name="Matiere">
						<datalist id="mat">
