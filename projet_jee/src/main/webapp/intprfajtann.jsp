...
<body class="g-sidenav-show  bg-gray-200">
	...
	<div class="sidebar close" style="background-color:black;">
		...
		<ul class="nav-links">
			...
			<li>
				<div class="iocn-link">
					<a href="intprofempl.jsp"> <i class='bx bx-stopwatch'></i> <span
			...
			<li><a href="intprofann.jsp"> <i class='bx bxs-news'></i> <span
				...
				<ul class="sub-menu blank">
					<li><a class="link_name" href="intprofann.jsp">Annonces</a></li>
				</ul></li>
	...
	<div class="fr" style=" width: 80%; float: right;margin-right: 7%;background-color:white; border-radius:10px;">
            <h1 style="font-family: 'FS Me', sans-serif;margin-left:113px;">Ajouter Un Annonce</h1>
            <form method="post" action="Ajtanc">
               <div class="form-group" style="display:flex; width:90%;margin-left:35px;">
      <label for="student-formation" style="color:black;">Description de la formation</label>
      <textarea style="width:50%;margin-left:12px;border-color:black;border-radius:7px;" class="form-control" id="formation" placeholder="Entrez la description de la formation" name="formation"></textarea>
   </div>
