	...
	<section class="home-section">
		...
		<main
			...
			<div class="fr"
				...
				<h1 style="font-family: 'FS Me', sans-serif; margin-left: 113px;">Modifier
					Un prof</h1>
					...
					<% ResultSet rs = et.collecteetuds(idf);  String es=" ";%>
					<%while(rs.next()){ %>
				<form method="POST" action="Editabs">
					...
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Niveau </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("niveau")%>" name="Mail" readonly> 
						<label for="student-name" style="color: black;">Mail </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("mail")%>" name="Mail" readonly> 
					</div>
