...
<title>Paiments Des Profs</title>
<!--     Fonts and icons     -->
...
<body class="g-sidenav-show  bg-gray-200">
				...
				<nav>
					...
					<ul>
						<li style="color: #E3452F;"><i
							class="fa-solid fa-right-from-bracket" style="color: #E3452F;"></i>Log
							out</li>
					</ul>
				</nav>
			</div>
	...
	<section class="home-section">
		<div class="home-content">
			...
			<!-- <div>
				<a href="Ajouterprofsgpamt.jsp"><button>
		...
		<main
			...
			<div
				...
				<span>Home/Paiments</span><span style="color: #2596be;">/</span><span
					style="color: #2596be; text-decoration: underline;">Profs</span>
			</div>
			<div class="search-container" style="margin-left: 59%;">
				<form style="display: flex; align-items: center;" action="Searchetdpaim"  method="post">
									...
									<table class="table align-items-center mb-0">
										<thead>
											<tr>
												...
												<th
													class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Octobre</th>
												<th
													class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">November</th>
												<th
										...
										<tbody>
											...
											<tr>
												...
												<td class="align-middle" style="color: green;">
													<form action="Ajouterprofsgpamt.jsp" method="post">
