...
<body>
	...
	<!-- Page info -->
	<div class="page-info-section set-bg" data-setbg="asts/img/page-bg/3.jpg">
		<div class="container">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9">
					<!-- blog post -->
					<div class="blog-post">
						<img src="asts/img/blog/1.jpg" alt="">
						<h3>How to create the perfect resume</h3>
						<div class="blog-metas">
							<div class="blog-meta author">
								<div class="post-author set-bg" data-setbg="asts/img/authors/1.jpg"></div>
					...
					<!-- blog post -->
					<div class="blog-post">
						<img src="asts/img/blog/2.jpg" alt="">
						<h3>5 Tips to make money from home</h3>
						<div class="blog-metas">
							<div class="blog-meta author">
								<div class="post-author set-bg" data-setbg="asts/img/authors/2.jpg"></div>
								<a href="#">James Smith</a>
							</div>
							<div class="blog-meta">
								<a href="#">Development</a>
					...
					<!-- blog post -->
					<div class="blog-post">
						<img src="asts/img/blog/3.jpg" alt="">
						<h3>Why choose an online course?</h3>
						<div class="blog-metas">
							<div class="blog-meta author">
								<div class="post-author set-bg" data-setbg="asts/img/authors/3.jpg"></div>
								<a href="#">James Smith</a>
							</div>
							<div class="blog-meta">
								<a href="#">Development</a>
				...
				<div class="col-lg-3 col-md-5 col-sm-9 sidebar">
					...
					<div class="sb-widget-item">
						<div class="add">
							<a href="#"><img src="asts/img/add.jpg" alt=""></a>
						</div>
					</div>
				</div>
			</div>
