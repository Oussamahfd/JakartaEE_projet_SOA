						...
						<div class="card my-4" style="border-radius:12px;">
							<div
								...
								<div class=" shadow p-3 border-radius-lg pt-4 pb-3" style="BACKGROUND-COLOR:BLACK;">
									<h6 class="text-white text-capitalize ps-3" style="text-align:center;font-size:18pt;"><b>Table Des paiments(Profs)</b></h6>
								</div>
							</div>
							<div class="card-body px-0 pb-2">
								<div class="table-responsive p-0">
									<table class="table align-items-center mb-0">
										...
										<% ResultSet rs = et.oneprpai(fullId);  String es=" ";%>
										<tbody>
										<%while(rs.next()){ %>
