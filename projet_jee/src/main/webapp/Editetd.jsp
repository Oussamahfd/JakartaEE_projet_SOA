...
<title>Modifier Etudiant(e)</title>
<!--     Fonts and icons     -->
				...
				<form method="POST" action="Editetd">
					...
					<div class="form-group"
						...
						<label for="student-name" style="color: black;">Mail </label> <input
							...
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("mail")%>" name="Mail"> <label
							for="student-id" style="color: black;">Phone </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="id_etudient"
							value="<%=rs.getString("phone")%>" name="Phone">
					</div>
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						...
						<input type="password"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("mdp")%>" name="Password">
							<label for="student-name"
									style="color: black;">Niveau </label>
                  <input list="niveaux" type="text"
									style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
									class="form-control" id="nom_etudient"
									value="<%=rs.getString("niveau")%>" name="Niveau">
						

					</div>
					<div class="form-group" style="display: flex; width: 90%; margin-left: 35px;">
    <% 
        int i = 1; // Initialiser i en dehors de la boucle
        while (rsm.next()) { 
    %>
        <input list="mat" type="text" style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
        class="form-control" id="nom_etudient" value="Matiere <%=i%>: <%=rsm.getString("nom_mat")%>" name="Matiere" readonly>
