...
<body class="g-sidenav-show  bg-gray-200">
	...
	<div>
		<header class="topbar" style="background-color: black;">
			...
			<span class="navigation__group"> <img class="icon"
				...
				class="profile" src="assets/img/profileo.png"
				alt="Joe Doe Picture">
			</span>
	...
	<section class="home-section">
		...
		<main
			...
			<div class="fr"
				style="width: 80%; float: right; margin-right: 7%; background-color: white; border-radius: 10px;">
				<h1 style="font-family: 'FS Me', sans-serif; margin-left: 113px;">Ajouter Absence</h1>
					<% String  strid = request.getParameter("userIddd");
					int idf = Integer.parseInt(strid);
					session.setAttribute("ideditp", idf);
					%>
					
					<% ResultSet rs = et.collecteprof(idf);  String es=" ";%>
					<%while(rs.next()){ %>
				<form method="POST" action="Editabs">
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Nom </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("nom")%>" name="Nom" readonly> <label
							for="student-id" style="color: black;">Prenom </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="id_etudient"
							value="<%=rs.getString("prenom")%>" name="Prenom" readonly>
					</div>
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Mail </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("mail")%>" name="Mail" readonly> <label
							for="student-id" style="color: black;">Phone </label> <input
							type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="id_etudient"
							value="<%=rs.getString("phone")%>" name="Phone" readonly>
					</div>
					
					<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Matiere </label> <input
							list="mat" type="text"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="nom_etudient"
							value="<%=rs.getString("mail")%>" name="Matiere" readonly>
						<datalist id="mat">
							<option value="MATH"><option value="PHYSIQUE">
                  ...
                  <label for="student-name"
									style="color: black;">Niveau </label>
                  <input list="niveaux" type="text"
									style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
									class="form-control" id="nom_etudient"
									value="<%=rs.getString("niveau")%>" name="Niveau" readonly>
                  <datalist id="niveaux">
        <option value="2-bac-sm">
							...
							<div class="form-group"
						style="display: flex; width: 90%; margin-left: 35px;">
						<label for="student-name" style="color: black;">Date D'absence </label> <input
							type="date"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="date_a" placeholder="Entrez la note de l'étudiant" name="date_a"> <label
							for="student-id" style="color: black;">Heur D'absence </label> <input
							type="time"
							style="width: 50%; margin-left: 10px; border-color: black; border-radius: 7px;"
							class="form-control" id="heur" placeholder="Entrez la note de l'étudiant" name="heur">
					</div>
               
               <div style="display:flex;margin-left:40%;">
               <button type="submit" class="btn btn-primary"
							style="background-color:black;border-radius:9px;"
							onmouseover="this.style.color='black'"
							onmouseout="this.style.color='white'">Enregistrer</button>
                <button type="button" class="btn btn-primary"
							style="margin-left:4px;background-color:black;border-radius:9px;"
							onmouseover="this.style.color='black'"
							onmouseout="this.style.color='white'">Annuler</button>
                </div>
            </form>
            <%} %>
         </div>
